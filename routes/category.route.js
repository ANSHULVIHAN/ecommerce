...
//const { isAuthenticated } = require('../middlewares/authentication.validators');
...
const routes = (app) =>{
    ...
    // to create a new category 
    app.post('/ecomm/api/v1/categories',isAuthenticated ,CategoryMiddleware.validateCreate, CategoryController.createCategory)

    // to get all categories by id 
    app.get('/ecomm/api/v1/categories/:id', CategoryController.getCategoriesById);

    // to get all catecomm/api/v1/categoriesByNameegories by name 
    app.get('/ecomm/api/v1/categoriesByName/', CategoryController.getCategoriesByName);
